...
func parseHandRounds(r io.Reader) []handRound {
...
func main() {
	...
	fmt.Println(part01(rounds))
	fmt.Println(part02(rounds))
}

func part01(rounds []handRound) int {
...
func part02(rounds []handRound) int {
